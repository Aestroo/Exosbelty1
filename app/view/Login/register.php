...
<body>
    ...
    <div class="container">
        <div class="login general-text-font">Create your account</div>
        <div class="input-box">
            <div class="logo">
            ...
            <input type="number" placeholder="NIS" class="input">
        </div>
        <div class="input-box">
            <div class="logo">
        ...
        <div class="input-box">
            ...
            <div class="input password">
                <input type="password" id="confirm-password" placeholder="Confirm Password" style="flex-grow: 1;">
                <span class="material-symbols-outlined" id="toggleIcon-2">&#xe8f5;</span>
            </div>
        </div>
    </div>
    <a href="asdasad.php" class="general-text-font forgot-password">Forgot password?</a>
    <button class="general-text-font login-btn" onclick="window.location.href='mainmenu.html'">Login</button>
    <div class="sign-up">
        <label for="" class="general-text-font sign-up-text">Don't have an account?</label>
        <a href="index.html" class="general-text-font sign-up-text">Sign In</a>
    </div>
