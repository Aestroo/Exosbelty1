...
<body>
        ...
        <div class="header-contain">
            <div class="top">
                ...
                <div class="right-content">
                    <a href="ekor angin/Notification.html" class="notification">
                    ...
                    <a href="ekor angin/Profile .html">
                        <img src="Profil.png" alt="" class="profile">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="contain">
            <div class="sort-by top">
                ...
                <a href="soloproject.html" class="poppins" style="font-size: 12px;">View All</a>
            </div>
            <div class="item">
                <div class="list solo" onclick="window.location.href='ekor angin/task.html'">
                    <div class="plain">
                        <div class="info">
                        ...
                        <div class="deadline work-sans">
                            <div class="logo">
                                <svg width="18" height="19" viewBox="0 0 18 19" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M12 0.5V4.5M6 0.5V4.5M17.4826 9.5H0.517334M17.4826 9.5C17.2743 3.79277 15.154 2 9 2C2.84596 2 0.725603 3.79277 0.517334 9.5M17.4826 9.5C17.4943 9.82084 17.5 10.154 17.5 10.5C17.5 17 15.5 19 9 19C2.5 19 0.5 17 0.5 10.5C0.5 10.154 0.505626 9.82084 0.517334 9.5"
        ...
        <div class="contain">
            <div class="sort-by top">
                ...
                <a href="groupprojects.html" class="poppins" style="font-size: 12px;">View All</a>
            </div>
            <div class="item row-task">
                <div class="list" onclick="window.location.href='ekor angin/task.html'">
                    <div class="group gradient-1">
                        <div class="group-inner-text">
                            <div class="mapel2 poppins">PBO</div>
                            <div class="task-remaining poppins">12 Projects</div>
                        </div>
                    </div>
                    <div class="bottom-group">
                        ...
                        <div class="progress-member">
                            ...
                            <div class="member">
                                <img src="Profil.png" alt="" class="ellipse">
                                <img src="Profil.png" alt="" class="ellipse">
                                <img src="Profil.png" alt="" class="ellipse">
                ...
                <div class="list" onclick="window.location.href='ekor angin/task.html'">
                    ...
                    <div class="bottom-group">
                        <div class="percentage poppins">45%</div>
                        <div class="progress-member">
                            <div class="progress-bar-empty">
                                <div class="progress-bar gradient-1" style="width: 45px;"></div>
                            </div>
                            <div class="member">
                                <img src="Profil.png" alt="" class="ellipse">
                                <img src="Profil.png" alt="" class="ellipse">
    ...
    <div id="overlay" class="">
        <div class="menu">
            ...
            <div class="container">
                <div class="nav-button-list">
                    <button class="navigation" onclick="pathFind()">
                    ...
                    <button class="navigation" onclick="window.location.href='soloproject.html'">
                        <div class="left-content">
                    ...
                    <button class="navigation" onclick="window.location.href='groupprojects.html'">
                        <div class="left-content">
                    ...
                    <button class="navigation" onclick="window.location.href='ekor angin/Calender Screen.html'">
                        <div class="left-content">
                    ...
                    <button class="navigation" onclick="window.location.href='complatedtask.html'">
                        <div class="left-content">
        ...
        <div class="option">
            <div class="container">
                <div class="nav-button-list">
                    <button class="navigation" onclick="window.location.href='ekor angin/Notification.html'">
                        <div class="left-content">
                    ...
                    <button class="navigation" onclick="window.location.href='ekor angin/Settings .html'">
                        <div class="left-content">
                    ...
                    <button class="navigation" onclick="window.location.href='index.html'">
                        <div class="left-content">
                    ...
                    <div class="navigation" style="display: flex; align-items: center; margin: 20px 0 30px 0;">
                        <a href="ekor angin/Profile .html   ">
                            <img src="Profil.png" alt="" class="left-content">
                        </a>
                        <div>
                            <div>Nama</div>
                            <div>Email</div>
    ...
    <script src="overlay_menu.js"></script>
</body>
